...
@section('title', 'Contact | Rasalina - Personal Portfolio HTML Template')


@section('main_body')

    @include('frontend.body.breadcrumb', ['title' => 'Contact Us'])
    <!-- contact-map -->
    <div id="contact-map">
        <iframe
    ...
    <div class="contact-area">
        <div class="container">
            <form action="{{ route('contact.insert') }}" class="contact__form" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
